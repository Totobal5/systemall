/// @desc Returns the shared variables from the CrispyTest constructor.
/// @return {Struct}
...
/// @ignore
/// @desc Helper function for Crispy to display debug messages
...
/// @ignore
/// @desc Helper function for Crispy to display error messages. If CRISPY_STRICT_MODE is enabled, the game will also close immediately with an error.
/// @param {Any} msg - Text to be displayed in the Output Window
...
/// @ignore
/// @desc Helper function for structs that replaces variable values with given source struct values
...
/// @ignore
/// @desc Helper function that returns whether or not a given variable name follows internal variable naming convention
/// @param {String} name - Name of variable to check
/// @return {Bool} Whether the given string follows internal variable naming convention
...
/// @ignore
/// @desc Helper function to validate unpack parameter (DRY validation)
...
/// @ignore
/// @desc Helper function to validate struct parameter type (DRY validation)
/// @param {String} context - Context for error message
/// @param {String} method - Method name for error message
/// @param {String} param_name - Parameter name for error message
/// @param {Any} param_value - Parameter value to validate
/// @return {Bool} True if valid struct, false otherwise
/// @ignore
...
/// @ignore
/// @desc Helper function to validate message parameter (DRY validation)
/// @param {String} context - Context for error message
/// @param {String} method - Method name for error message
/// @param {Any} message - Message value to validate
/// @return {Bool} True if valid message or undefined, false otherwise
/// @ignore
...
/// @ignore
/// @desc Helper function to get type display string (DRY type checking)
/// @param {Any} value - Value to get type display for
/// @return {String} Constructor name if struct, otherwise typeof
/// @ignore
...
/// @ignore
/// @desc Helper function to validate and set method parameter (DRY validation)
/// @param {String} context - Context for error message
/// @param {String} method_name - Method name being set
/// @param {Any} func - Function value to validate
/// @return {Struct} Bound method if valid, undefined otherwise
/// @ignore
...
/// @ignore
/// @desc Helper function to validate specific type parameter (DRY validation)
/// @param {String} context - Context for error message
/// @param {String} method - Method name for error message
/// @param {String} param_name - Parameter name for error message
/// @param {Any} param_value - Parameter value to validate
/// @param {String} expected_type - Expected type name (e.g., "string", "real", "bool")
/// @return {Bool} True if valid type, false otherwise
/// @ignore
