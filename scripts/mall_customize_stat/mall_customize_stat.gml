...
/// @param	{Function}		[display_method]	function([FLAG]) {return string; } (se ejecuta en base a PartyStatsAtom)
/// @returns {Struct.MallStat}
function mall_customize_stat(_KEY, _INITIAL=0, _TYPE=0, _MIN=MALL_STAT_DEFAULT_MIN, _MAX=MALL_STAT_DEFAULT_MAX, _DISPLAY_KEY, _DISPLAY_METHOD) 
{
	...
	{
		_stat.setValue(_INITIAL, _TYPE, _MIN, _MAX);
		return (_stat.setDisplay(_DISPLAY_KEY, _DISPLAY_METHOD) );
	}
