...
function bag_init() {
    ...
    bag_item_add("ARM.ESPADA_COBRE" , (bag_create_item("Espadas", 2000, 1250) ).StatsArgument("fue", 10, "int",  20) );
	bag_item_add("ARM.ESPADA_VENENO", (bag_create_item("Espadas", 5000, 1250) ).StatsArgument("fue", 120, "int", -120) )
	.SetSpecial("DARK.GSPELL.BASIC", {state:"veneno", chance: Data("30%") } );
	
	bag_item_add("ARM.ESPADA_GRANDE", (bag_create_item("Espadas", 6500, 900)  ).StatsArgument("fue", 125, "int", -10).SetUse(2) );
