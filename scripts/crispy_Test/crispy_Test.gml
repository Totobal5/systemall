/// @desc Base constructor that test constructors will inherit from
...
function CrispyTest(_name) constructor
{
	...
	/// @desc Get the name of this test
	...
	/// @desc Event to be called at the beginning of run
	...
	/// @desc Event to be called at the end of run
