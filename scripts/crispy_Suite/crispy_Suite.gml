/// @desc Testing suite that holds tests
...
function CrispySuite(_name, _unpack = undefined) : CrispyTest(_name) constructor 
{
	...
	/// @desc Adds CrispyCase to array of cases
	...
	/// @desc Returns whether the suite is currently running.
	/// @return {Bool}
	...
	/// @desc Returns whether the suite has completed.
	/// @return {Bool}
	...
	/// @desc Event that runs before all tests to set up variables. Can also overwrite __SetUp
	...
	/// @desc Event that runs after all tests to clean up variables. Can also overwrite __TearDown
	...
	/// @desc Updates asynchronous tests and finalizes the suite when they complete.
	/// @return {Struct.CrispySuite} Self for chaining
