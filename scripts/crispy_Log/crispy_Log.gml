/// @desc Saves the result and output of assertion
...
function CrispyLog(_test_case, _unpack = undefined) constructor
{
	...
	/// @desc Constructs text based on outcome of test assertion and verbosity
	/// @return {String} Text based on outcome of test assertion and verbosity
